...
const Launch = props => {
  ...
  return <Appear id="launch" animate show={props.entered}>
    ...
    <form onSubmit={props.submitLaunch} style={{display: "inline-grid", gridTemplateColumns: "1fr 1fr", gridGap: "10px 20px"}}>
      <label htmlFor="launch-day">Launch Date</label>
      <input type="date" id="launch-day" name="launch-day" min={today} max="2040-12-31" defaultValue={today} />
      <label htmlFor="launch-customers">Launch Customers</label>
      <input type="text" id="launch-customers" name="launch-customers" />
